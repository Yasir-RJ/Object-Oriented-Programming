...
import se.kth.yasir.labb3.shapes.*;

public class App extends Application {

    private World world;

    private Canvas canvas; // the surface where pad and balls are drawn
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("Shapes (Yasir Riyadh)");
